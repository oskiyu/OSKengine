...
namespace OSK {
	...
	/// </summary>
	class OSKAPI_CALL OldMaterial {

		friend class OldMaterialSystem;
	...
	public:
		...
		void SetRenderer(const RenderAPI* renderer);
	...
	private:
		...
		/// </summary>
		UniquePtr<OldMaterialPool> pool;
