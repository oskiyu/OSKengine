...
void main() {
    ...
    if (gl_InvocationID == 0) {
        ...
        vec4 pos0 = camera.view * model.modelMatrix * gl_in[0].gl_Position; 
        vec4 pos1 = camera.view * model.modelMatrix * gl_in[1].gl_Position; 
        vec4 pos2 = camera.view * model.modelMatrix * gl_in[2].gl_Position; 
