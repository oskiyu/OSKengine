...
namespace OSK {
	...
	std::array<VkVertexInputAttributeDescription, 4> Vertex::GetAttributeDescriptions_PositionColorTexNormals() {
	...
	std::array<VkVertexInputAttributeDescription, 3> Vertex::GetAttributeDescriptions_PositionColorTex() {
